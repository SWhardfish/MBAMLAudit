...
output_dir = f'ResultOutput/BGMaxFiles/{year}/{month}/Matched/'
...
directory_path = f'ResultOutput/BGMaxFiles/{year}/{month}/PreProcessed/InvoiceProcessed/NameProcessed'
...
for filename in os.listdir(directory_path):
    if filename.endswith('.json'):
        ...
        for payment in payments:
            ...
            if CompanyNumber:
                ...
                if not matching_row.empty:
                    ...
                    #CustomerNo = CompanyNumber  # Set CustomerNo to CompanyNumber when there's a match - REMOVED AS it is CONFUSING for Accounting
                else:
            ...
            try:
                ...
                Amount = None  # This can be set to a default value or handle it in another way as needed
        ...
        output_filename = f'ResultOutput/BGMaxFiles/{year}/{month}/Matched/{os.path.splitext(os.path.basename(filename))[0]}_output.csv'
